package au.edu.imb.structure.maps
/**
 * Mapping of amino acid names.
 * Version: 1.00
 ...
 *  and returns the first letter in lower case for unknown code.
 *  The latter ensures that nucleotide letters are passed through */
object AA3to1 {
  private lazy val map = Map[String,Char](
    ...
    def apply(code:String) = map.getOrElse(code, code.head.toLower)
}
